    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">{missions.length} missions · {completions.length} completions total</p>
        </div>
        <Button onClick={openAddMission} className="gap-2">
